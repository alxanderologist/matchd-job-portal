    ...
    <main class="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <header class="h-16 border-b border-slate-200/80 bg-white/80 backdrop-blur-md px-8 flex items-center justify-between sticky top-0 z-10">
            ...
            <div class="relative w-72">
                ...
                <input type="text" placeholder="Search templates or existing posts..." class="w-full pl-9 pr-4 py-1.5 text-xs bg-slate-100/80 border border-transparent rounded-lg focus:outline-none focus:border-[#1f48ff] focus:bg-white transition">
            </div>

            <!-- Action Controls -->
            <div class="flex items-center gap-3">
                <button class="bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs px-4 py-2 rounded-xl transition">
                    Save Draft
                </button>
                <button class="bg-[#1f48ff] hover:bg-[#1a3ed6] text-white font-semibold text-xs px-4 py-2 rounded-xl transition shadow-sm flex items-center gap-2">
                    <i data-lucide="send" class="w-4 h-4"></i> Publish Job Post
                </button>
            </div>
        </header>
        ...
        <div class="p-8 space-y-6 max-w-4xl w-full mx-auto">
            ...
            <!-- title of page -->
            <div>
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Post a New Job Opportunity</h1>
            ...
            <form id="job-form" class="space-y-6" method="POST" action="../employerPHP/create-job.php">
                ...
                <div class="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-4">
                    <h2 class="text-base font-bold text-slate-900 border-b border-slate-100 pb-3 flex items-center gap-2">
                        <i data-lucide="briefcase" class="w-4 h-4 text-[#1f48ff]"></i>
                        Job Details
                    </h2>
                ...
                <div class="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-4">
                    <div>
                        <h2 class="text-base font-bold text-slate-900 flex items-center gap-2">
                            <i data-lucide="tag" class="w-4 h-4 text-[#1f48ff]"></i>
                            Match Tags & Required Skills
                        </h2>
                        <p class="text-xs text-slate-500 mt-0.5">Applicants with matching tags will be automatically prioritized in your approval feed.</p>
                    </div>
